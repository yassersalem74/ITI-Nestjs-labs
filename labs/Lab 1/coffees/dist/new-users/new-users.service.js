...
exports.NewUsersService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let NewUsersService = class NewUsersService {
    constructor(todoModel) {
        this.todoModel = todoModel;
    }
    async create(createNewUserDto) {
...
exports.NewUsersService = NewUsersService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)("Todo")),
    __metadata("design:paramtypes", [mongoose_2.Model])
], NewUsersService);
//# sourceMappingURL=new-users.service.js.map